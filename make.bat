...
.qhcp project file in %BUILDDIR%/qthelp, like this:
	...
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\F5OpenSourceDocumentationTraining.ghc
	goto end
)
...
if "%1" == "docker-html" (
	./script/docker-docs.sh %SPHINXBUILD% -b html %ALLSPHINXOPTS% %BUILDDIR%/html
	if errorlevel 1 exit /b 1
	echo.
	echo.Build finished. The HTML pages are in %BUILDDIR%/html.
)
